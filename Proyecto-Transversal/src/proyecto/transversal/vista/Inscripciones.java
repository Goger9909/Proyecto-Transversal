...
public final class Inscripciones extends javax.swing.JInternalFrame {
  private DefaultTableModel modelo = new DefaultTableModel() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(112, 0, 193, 22));
        ...
        getContentPane().add(jCBAlumno, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 40, 205, -1));

        jLabel2.setText("Seleccione un alumno:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 40, 140, 26));

        jLabel3.setText(" Listado de Materias");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 84, 123, 28));
        ...
        getContentPane().add(MateriasNoInscriptas, new org.netbeans.lib.awtextra.AbsoluteConstraints(219, 118, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 152, 361, 154));
        ...
        getContentPane().add(Inscribir, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 324, -1, -1));
        ...
        getContentPane().add(AnularInscripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 324, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 324, -1, -1));
